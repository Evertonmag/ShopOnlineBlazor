...
namespace ShopOnline.Web.Pages.ProductsByCategory;
public class ProductsByCategoryBase : ComponentBase
{
    ...
    protected override async Task OnParametersSetAsync()
    {
        try
        {
            Products = await GetProductCollectionCategoryId(CategoryId);
    ...
    private async Task<IEnumerable<ProductDto>> GetProductCollectionCategoryId(int categoryId)
    {
